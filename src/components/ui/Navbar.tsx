...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-5 z-50 flex justify-center px-4 transition-transform duration-300">
      <div
        className={`flex items-center gap-4 rounded-full border px-6 py-2.5 transition-all duration-300 ${
          scrolled
      ...
      >
        <a
          href="#contact"
          className="hackx-btn-outline rounded-full px-5 py-2 text-[10px] font-bold uppercase tracking-wider"
        >
          CONTACT
        </a>
        <a
          href="#register"
          className="hackx-btn-primary rounded-full px-5 py-2 text-[10px] font-bold uppercase tracking-wider"
        >
          AMBASSADOR LOGIN
        </a>
      </div>
